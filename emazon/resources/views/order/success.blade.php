...
@section('content')
    <section class="flex items-center h-screen bg-gray-100 font-poppins dark:bg-slate-600">
                ...
                <div class="flex px-6 ">
                    <div class="py-1 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="w-6 h-6 mr-4 text-blue-500 dark:text-blue-400 bi bi-check2-circle" viewBox="0 0 16 16">
                            <path
